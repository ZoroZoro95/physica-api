...
def _requested_level_ground_outputs(text: str) -> list[str]:
    ...
    if any(marker in text for marker in ("maximum height", "max height", "greatest height", "greatest vertical rise", "maximum vertical rise", "how high", "peak height", "highest height", "maximum altitude", "altitude gained")) or "h" in output_tokens:
